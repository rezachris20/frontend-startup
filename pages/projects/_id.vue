              ...
              <div class="w-1/4">
                <img
                  :src="
                    ...
                    '/' +
                    campaign.data.data.user.image_url
                  "
                  alt=""
          ...
          <div class="relative progress-bar">
            ...
            >
              <div
                :style="
                  'width:' +
                  (campaign.data.data.current_amount /
                    campaign.data.data.goal_amount) *
                    100 +
                  '%'
                "
                class="
...
export default {
  ...
  mounted() {
    this.default_image =
      this.$axios.defaults.baseURL + '/' + this.campaign.data.data.image_url
  },
}
</script>